...
#
curl https://github.com/caleb/syslog_forwarder/releases/download/v$SYSLOG_FORWARDER_VERSION/syslog_forwarder-linux-amd64-v$SYSLOG_FORWARDER_VERSION.tar.gz > /tmp/syslog_forwarder.tar.gz
